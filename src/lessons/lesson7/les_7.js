...
let obj = new SuperTest('Nick', 32, 'Minsk')
console.log(obj)
let obj2 = new SuperTest('Yo', 32, 'Moscow')
console.log(obj2)
...
/*Function.prototype._bind = function (ctx, ...args) {
    ctx.___jjjfghjjjj___ = this
    return function (...arg2) {
        return ctx.___jjjfghjjjj___(...args, ...arg2)
    }
}

let obj = {name: 'Hanna'}
let obj2 = {
    name: 'Yo', sayName: function () {
